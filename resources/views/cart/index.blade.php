<x-app-layout>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    @auth
                        <a href="{{ route('orders.checkout') }}" class="block w-full text-center bg-green-600 text-black py-3 rounded-md hover:bg-green-700 font-semibold mb-2">
                            Checkout
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="block w-full text-center bg-blue-600 text-black py-3 rounded-md hover:bg-blue-700 font-semibold mb-2">
                    ...
                    <form action="{{ route('cart.clear') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full bg-gray-300 text-gray-700 py-2 rounded-md hover:bg-gray-400"
    ...
    @else
        <div class="bg-white rounded-lg shadow p-12 text-center">
            ...
            <a href="{{ route('products.index') }}" class="bg-blue-600 text-black px-6 py-2 rounded-md hover:bg-blue-700">
                Lanjut Belanja
            </a>
        </div>
    @endif
